...
class Result extends Model
{
    ...
    static function rules($update = false,  $data = [], $id = 0){
        $rules = [
            ...
            'grid' => 'required|integer|max:10000000000',
            'positionOrder' => 'required|integer|max:10000000000',
            'positiontext' => 'required|string|max:255',
            'points' => 'required|numeric',
            'laps' => 'required|integer|max:10000000000',
            'time' => 'nullable|string|max:255',
            'number' => 'nullable|integer|max:10000000000',
            'position' => 'nullable|integer|max:10000000000',
            'milliseconds' => 'nullable|integer|max:10000000000',
            'fastestLap' => 'nullable|integer|max:10000000000',
            'rank' => 'nullable|integer|max:10000000000',
